            ...
            <li class="scrollable-container media-list">
              <div class="media align-items-center">
                <img
                  ...
                  src="~/assets/app-assets/images/pages/eCommerce/1.png"
                  alt="donuts"
                  width="62"
                />
              ...
              <div class="media align-items-center">
                <img
                  class="d-block rounded mr-1"
                  src="~/assets/app-assets/images/pages/eCommerce/7.png"
                  alt="donuts"
                  width="62"
                />
                <div class="media-body">
              ...
              <div class="media align-items-center">
                <img
                  class="d-block rounded mr-1"
                  src="~/assets/app-assets/images/pages/eCommerce/2.png"
                  alt="donuts"
                  width="62"
                />
                <div class="media-body">
              ...
              <div class="media align-items-center">
                <img
                  class="d-block rounded mr-1"
                  src="~/assets/app-assets/images/pages/eCommerce/3.png"
                  alt="donuts"
                  width="62"
                />
                <div class="media-body">
              ...
              <div class="media align-items-center">
                <img
                  class="d-block rounded mr-1"
                  src="~/assets/app-assets/images/pages/eCommerce/5.png"
                  alt="donuts"
                  width="62"
                />
                <div class="media-body">
              ...
              <a class="d-flex" href="javascript:void(0)">
                <div class="media d-flex align-items-start">
                  <div class="media-left">
                    <div class="avatar">
                      <img
                        src="~/assets/app-assets/images/portrait/small/avatar-s-15.jpg"
                        alt="avatar"
                        width="32"
                        height="32"
                      />
              ...
              ><a class="d-flex" href="javascript:void(0)">
                <div class="media d-flex align-items-start">
                  <div class="media-left">
                    <div class="avatar">
                      <img
                        src="~/assets/app-assets/images/portrait/small/avatar-s-3.jpg"
                        alt="avatar"
                        width="32"
                        height="32"
                      />
        ...
        <li class="nav-item dropdown dropdown-user">
          ...
          >
            ...
            <span class="avatar"
              ><img
                class="round"
                src="~/assets/app-assets/images/portrait/small/avatar-s-11.jpg"
                alt="avatar"
                height="40"
